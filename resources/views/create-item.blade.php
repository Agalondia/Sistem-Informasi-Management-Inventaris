...
<div class="container-fluid ">
    ...
    <div class="mt-3 ml-4 mr-4 border-top">
        <form method="post" action="{{ route('dashboard.store') }}" enctype="multipart/form-data" class="mt-3">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    id="serial_number_barang" name="serial_number_barang" required autofocus value="{{ old('serial_number_barang') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date"
                    ...
                    id="tanggal_pembelian" name="tanggal_pembelian" required autofocus value="{{ old('tanggal_pembelian') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    id="harga_barang" name="harga_barang" required autofocus value="{{ old('harga_barang') }}">
                @error('harga_barang')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    id="nama_pengguna_barang" name="nama_pengguna_barang" required autofocus value="{{ old('nama_pengguna_barang') }}">
